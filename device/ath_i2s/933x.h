...
#define ATH_GPIO_FUNCTION_1     ATH_GPIO_BASE+0x28
...
#define ATH_STEREO_CLK_DIV          (ATH_STEREO_BASE+0x1c)
#define ATH_STEREO_TX_SAMPLE_CNT_LSB  (ATH_STEREO_BASE+0x0c)
#define ATH_STEREO_TX_SAMPLE_CNT_MSB  (ATH_STEREO_BASE+0x10)
#define ATH_STEREO_RX_SAMPLE_CNT_LSB  (ATH_STEREO_BASE+0x14)
#define ATH_STEREO_RX_SAMPLE_CNT_MSB  (ATH_STEREO_BASE+0x18)
