...
SOLIB_PATH=$SCRIPTPATH/lib/libspotify-embedded-mips/lib:$SOLIB_PATH

# Uncomment this for beep packages built by openwrt
SOLIB_PATH=$SCRIPTPATH/../openwrt/staging_dir/target-mips_r2_uClibc-0.9.33.2/root-ar71xx/beep/platform:$SOLIB_PATH

# Uncomment this for beep packages built with scons and copied manually
#SOLIB_PATH=$SCRIPTPATH/out/:$SOLIB_PATH

$MIPS_GDB -ex "set solib-search-path $SOLIB_PATH" $@
