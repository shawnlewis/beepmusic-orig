...
define Profile/BEEP_CM2_PRIMARY
        NAME:=Beep Carambola2 primary
        PACKAGES:=
endef

define Profile/BEEP_CM2_PRIMARY/Description
        Beep Carambola2 primary image target.
endef

$(eval $(call Profile,BEEP_CM2_PRIMARY))

define Profile/BEEP_CM2_RECOVERY
        NAME:=Beep Carambola2 recovery
        PACKAGES:=
endef

define Profile/BEEP_CM2_RECOVERY/Description
        Beep Carambola2 recovery image target.
endef

$(eval $(call Profile,BEEP_CM2_RECOVERY))
