...
ifdef CONFIG_BEEP_BUILD_DETERMINISTIC
  ifeq ($(strip $(PKG_BUILD_DETERMINISTIC)),1)
    TARGET_CFLAGS += -Wno-builtin-macro-redefined -imacros $(TOPDIR)/include/deterministic.h
    TARGET_CXXFLAGS += -Wno-builtin-macro-redefined -imacros $(TOPDIR)/include/deterministic.h
  endif
else
