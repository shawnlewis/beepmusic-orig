...
int serial_init(void){
	...
	/* GPIO Configuration */
#ifdef CONFIG_BEEP_HORNET_SERIAL
	ar7240_reg_wr(AR7240_GPIO_OE, 0x400);
#else  // CONFIG_BEEP_HORNET_SERIAL
	ar7240_reg_wr(AR7240_GPIO_OE, 0xcff);
#endif  // CONFIG_BEEP_HORNET_SERIAL
...
#ifdef CONFIG_BEEP_HORNET_SERIAL
	/* GPIO_FUN, bit1/UART_EN, bit15(disable_s26_uart) */
	rdata |= (0x3 << 1) | (0x1 << 15);
#else  // CONFIG_BEEP_HORNET_SERIAL
