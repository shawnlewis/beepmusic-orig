...
void gpio_config(void){
    ...
    ar7240_reg_wr(AR7240_GPIO_FUNC, (ar7240_reg_rd(AR7240_GPIO_FUNC) & 0x00048002));

    // Same for OE
    ar7240_reg_wr(AR7240_GPIO_OE, (ar7240_reg_rd(AR7240_GPIO_OE) & 0x00000400));

    // Enable GPIO26/GPIO27 control in BOOT_STRAP
    ar7240_reg_wr(HORNET_BOOTSTRAP_STATUS, (ar7240_reg_rd(HORNET_BOOTSTRAP_STATUS) | 0x00040000));
#elif defined(CONFIG_FOR_BEEP01)
    // Ensure GPIO_FUNC is in the reset state, except for serial.
    ar7240_reg_wr(AR7240_GPIO_FUNC, (ar7240_reg_rd(AR7240_GPIO_FUNC) & 0x00048002));
...
#elif defined(CONFIG_FOR_BEEP_CM2)  // Suppress the error below.
#elif defined(CONFIG_FOR_BEEP01)
#else
