...
#if !defined(CONFIG_FOR_BEEP_CM2) && \
    !defined(CONFIG_FOR_BEEP01)
...
#elif defined(CONFIG_FOR_BEEP_CM2) || \
	defined(CONFIG_FOR_BEEP01)
	#define	CFG_LOAD_ADDR			 0x9F050000
	#define UPDATE_SCRIPT_FW_ADDR	"0x9F050000"
#else
...
#elif defined(CONFIG_FOR_BEEP_CM2) || \
	defined(CONFIG_FOR_BEEP01)
	#define CONFIG_BOOTCOMMAND "bootb"
#else
 ...
 * bits 23..25	(3bit)	OUTDIV	(Define the ratio between VCO output and  output	=>	1	(0x1)	[value == 0 is illegal!]
...
#elif defined(CONFIG_FOR_BEEP_CM2) || \
	defined(CONFIG_FOR_BEEP01)
// env0 is after u-boot
// env1 is before art
    #define CFG_ENV_ADDR            0x9F040000
    #define CFG_ENV_SIZE            0x8000
    #define CFG_ENV_ADDR_REDUND     0x9FFE0000
    #define CFG_ENV_SIZE_REDUND     0x8000
    #define CFG_ENV_SECT_SIZE       0x10000
#else
	#define CFG_ENV_ADDR		0x9F040000
 ...
 */
	...
	#define CONFIG_COMMANDS (CFG_CMD_BOOTD  | \
							 CFG_CMD_DATE   | \
							 CFG_CMD_DHCP   | \
							 CFG_CMD_ECHO   | \
							 CFG_CMD_ENV    | \
...
#if defined(CONFIG_FOR_BEEP_CM2) || \
    defined(CONFIG_FOR_BEEP01)
#define _ADDR_TO_STR(ADDR) #ADDR
#define ADDR_TO_STR(ADDR) _ADDR_TO_STR(ADDR)
#define CONFIG_EXTRA_ENV_SETTINGS \
    "beep_recovery=" ADDR_TO_STR(CONFIG_DEFAULT_RECOVERY_ADDR) "\0" \
    "beep_primary=" ADDR_TO_STR(CONFIG_DEFAULT_PRIMARY_ADDR) "\0" \
    "board=" BOARD_ENV_NAME "\0" \
    "version=" ENV_VERSION "\0"
#else
...
#elif defined(CONFIG_FOR_BEEP_CM2) || \
    defined(CONFIG_FOR_BEEP01)
// Leaving this as unset to disable setclk and clearclk in cmd_custom.c
#elif defined(CONFIG_FOR_DRAGINO_V2) || \
      defined(CONFIG_FOR_MESH_POTATO_V2)
	/*
	 * We will store PLL and CLOCK registers
