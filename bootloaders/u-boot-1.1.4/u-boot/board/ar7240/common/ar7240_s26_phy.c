...
#endif
    int       phyUnit;
    uint32_t  phyBase __attribute__((unused)) = 0;
    BOOL      foundPhy __attribute__((unused)) = FALSE;
    uint32_t  phyAddr = 0;
    uint32_t ar7240_revid;
...
static unsigned int phy_val_saved __attribute__((unused)) = 0;
/******************************************************************************
*
...
athrs26_phy_is_link_alive(int phyUnit)
{
    ...
    uint32_t phyBase __attribute__((unused));
    uint32_t phyAddr;
    phyBase = ATHR_PHYBASE(phyUnit);
    phyAddr = ATHR_PHYADDR(phyUnit);
...
athrs26_phy_is_fdx(int ethUnit)
{
    int       phyUnit;
    uint32_t  phyBase __attribute__((unused));
    uint32_t  phyAddr __attribute__((unused));
    uint16_t  phyHwStatus;
    int       ii = 200;
